    ...
    <ThemedView>
      <ThemeCard>
          ...
          <SectionList
              ...
              renderItem={ ( { item } ) => <ThemedText className='dark:text-white'>{item}</ThemedText> }
              ListHeaderComponent={ () => (
                <ThemedText type='h1' className='font-bold mb-3 dark:text-white'>
                  Personajes
                </ThemedText>
              )}
              renderSectionHeader={ ({section} )  => (
                <ThemedText type='h1' className='bg-ligth-background dark:bg-dark-background p-2 rounded dark:text-white'>{section.title}</ThemedText>
              )}
              stickySectionHeadersEnabled

              ListFooterComponent={ () => (
                <ThemedText type='h1' className='font-bold dark:text-white bg-light-background dark:bg-dark-background p-2 mb-10 rounded'>
